...
const inserirDadosMotores = async (req, res) => {
    ...
    try {
        ...
        for (const [MotorID, dados] of Object.entries(dadosSensoresMotoresVar)) {
            await client.query(
                `INSERT INTO dados_sensores_motores (ColetaID, MotorID, Temperatura, Frequencia, Corrente, Vibracao, Pressao) 
                VALUES ($1, $2, $3, $4, $5, $6, $7);`,
                [coletaID, MotorID, dados.Temperatura, dados.Frequencia, dados.Corrente, dados.Vibracao, dados.Pressao]
            );
        }
